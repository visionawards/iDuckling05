...
class iDController extends iDControllerHelper {
    public function __construct() {
        parent::__construct();

        //by defining this here, we can use both two different
        //SITE_ID objects: one for this, the other for the one
        //in iDControllerHelper
        $this->{SITE_ID} = $this;
    }
}
